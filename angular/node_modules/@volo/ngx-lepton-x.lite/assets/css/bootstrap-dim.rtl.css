...
.form-select {
  display: block;
  width: 100%;
  padding: 0.675rem 1.25rem 0.675rem 3.75rem;
...
.was-validated .form-control:valid, .form-control.is-valid {
  border-color: #4fbf67;
  padding-left: calc(1.5em + 1.35rem);
  ...
  background-repeat: no-repeat;
  background-position: left calc(0.375em + 0.3375rem) center;
...
.was-validated textarea.form-control:valid, textarea.form-control.is-valid {
  padding-left: calc(1.5em + 1.35rem);
  background-position: top calc(0.375em + 0.3375rem) left calc(0.375em + 0.3375rem);
}
...
.was-validated .form-select:valid:not([multiple]):not([size]), .was-validated .form-select:valid:not([multiple])[size="1"], .form-select.is-valid:not([multiple]):not([size]), .form-select.is-valid:not([multiple])[size="1"] {
  ...
  background-position: left 1.25rem center, center left 3.75rem;
...
.navbar.navbar-light.bg-light .nav-item .nav-link:hover {
  color: rgba(22, 22, 22, 0.7) !important;
}
.navbar.navbar-light.bg-light .nav-item .nav-link.active {
  color: #161616 !important;
}
...
/*# sourceMappingURL=bootstrap-dim.rtl.css.map */