...
class Body {
    constructor(options) {
        ...
        this.registerActionParameter = (param) => {
            ...
            if (descriptorName) {
                value = (0, methods_1.getParamValueName)(paramName, descriptorName);
            }
            switch (bindingSourceId) {
                ...
                case enums_1.eBindingSourceId.Query:
                    ...
                    break;
                case enums_1.eBindingSourceId.FormFile:
    ...
    isBlobMethod() {
        return constants_1.VOLO_REMOTE_STREAM_CONTENT.some(x => x === this.responseTypeWithNamespace);
    }
    setUrlQuotes() {
