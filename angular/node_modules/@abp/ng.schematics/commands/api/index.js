...
function default_1(schema) {
    ...
    return (0, schematics_1.chain)([
        async (tree) => {
            ...
            data.types = (0, utils_1.sanitizeTypeNames)(data.types);
            (0, utils_1.resolveSelfGenericProps)({ solution, types: data.types });
            ...
            data.modules[moduleName].controllers = (0, utils_1.sanitizeControllerTypeNames)(definition.controllers);
            const controllers = filterControllersByServiceType(serviceType, data.modules[moduleName].controllers);
...
function createModelGenerator(params) {
    ...
    (0, utils_1.resolveAbpPackages)(models);
