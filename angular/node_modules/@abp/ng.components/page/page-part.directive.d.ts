...
export declare class PagePartDirective implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PagePartDirective, "[abpPagePart]", never, { "context": { "alias": "abpPagePartContext"; "required": false; }; "abpPagePart": { "alias": "abpPagePart"; "required": false; }; }, {}, never, never, false, never>;
}
