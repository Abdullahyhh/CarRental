...
export declare class FeatureManagementComponent implements FeatureManagement.FeatureManagementComponentInputs, FeatureManagement.FeatureManagementComponentOutputs {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FeatureManagementComponent, "abp-feature-management", ["abpFeatureManagement"], { "providerKey": { "alias": "providerKey"; "required": false; }; "providerName": { "alias": "providerName"; "required": false; }; "providerTitle": { "alias": "providerTitle"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, { "visibleChange": "visibleChange"; }, never, never, true, never>;
}
export {};
